...
- Pkg folder: [packages\sync-errors](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\sync-errors)
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package sync-errors -Apply
