...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'source', 'event_key', 'peer_id', 'error', 'created_at' ];
    }
    ...
    {
        $x = [ 'id', 'source', 'event_key', 'peer_id', 'error', 'created_at' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\SyncErrors\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\SyncErrors\Definitions::softDeleteColumn();
