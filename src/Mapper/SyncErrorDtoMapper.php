...
namespace BlackCat\Database\Packages\SyncErrors\Mapper;

use BlackCat\Database\Packages\SyncErrors\Dto\SyncErrorDto;
use BlackCat\Database\Packages\SyncErrors\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO SyncErrorDto:
...
final class SyncErrorDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'peer_id' ];
    /** @var string[] */
     ...
     * @return SyncErrorDto
     */
    public static function fromRow(array $row): SyncErrorDto
    {
        /** @var SyncErrorDto */
    ...
    public static function fromRowOrNull(?array $row): ?SyncErrorDto
    {
     ...
     *
     * @param SyncErrorDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(SyncErrorDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(SyncErrorDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(SyncErrorDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,SyncErrorDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,SyncErrorDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(SyncErrorDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,SyncErrorDto>
     */
