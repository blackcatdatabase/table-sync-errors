...
use BlackCat\Database\Packages\SyncErrors\Repository\SyncErrorRepository;
...
{
    private SyncErrorRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new SyncErrorRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\SyncErrors\Dto\SyncErrorDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\SyncErrors\Dto\SyncErrorDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\SyncErrors\Dto\SyncErrorDto|null
    {
