...
use BlackCat\Database\Packages\SyncErrors\Repository\SyncErrorRepositoryInterface;
use BlackCat\Database\Packages\SyncErrors\Repository\SyncErrorRepository as GeneratedRepository;
...
{
  private SyncErrorRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof SyncErrorRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected SyncErrorRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\SyncErrors\Dto\SyncErrorDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\SyncErrors\Dto\SyncErrorDto|null { return $this->repo->getById($id, $asDto); }
