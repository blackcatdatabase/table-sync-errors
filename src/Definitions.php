...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'sync_errors'; }
    public static function contractView(): string { return 'vw_sync_errors'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'source', 'event_key', 'peer_id', 'error', 'created_at' ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'peer_id' ]; }
